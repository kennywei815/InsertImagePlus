    ...
    With Application.FileDialog(msoFileDialogOpen)
        ...
        If .Show = -1 Then
            ...
            For lngCount = 1 To .SelectedItems.Count
                ...
                Command = "cmd /C " & Environ("APPDATA") & "\Microsoft\AddIns\TeX4Office_Editor\" & "convert   -units PixelsPerInch  -density 1200 -resize 1200x1200 " & QuotedStr(.SelectedItems(lngCount)) & " " & QuotedStr(TempDir & pictureFileName)
